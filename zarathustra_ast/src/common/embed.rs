...
cfg_if::cfg_if! {
    if #[cfg(feature = "bellman")] {
        ...
        use zarathustra_embed::{bellman::{from_bellman, generate_sha256_round_constraints}};
    }
}
...
cfg_if::cfg_if! {
    if #[cfg(feature = "ark")] {
        ...
        use zarathustra_embed::ark::{from_ark, generate_verify_constraints};
    }
}
...
mod tests {
    ...
    mod sha256 {
        ...
        fn generate_sha256_constraints() {
            ...
            // bellman input #0: index 1 should equal zarathustra input #0: index v_count
            assert_eq!(
