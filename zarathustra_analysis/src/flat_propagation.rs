...
use std::ops::*;
use zarathustra_ast::common::expressions::IdentifierOrExpression;
use zarathustra_ast::common::WithSpan;
use zarathustra_ast::flat::folder::*;
...
impl<'ast, T: Field> Folder<'ast, T> for Propagator<T> {
    ...
    fn fold_identifier_expression(
        &mut self,
        e: zarathustra_ast::common::expressions::IdentifierExpression<Variable, FlatExpression<T>>,
