...
```
{{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:11}}
```
...
```
$ {{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:15}}
...
```
$ {{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:18}}
...
```
$ {{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:21}}
...
```
$ {{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:24}}
...
```
$ {{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:27}}
...
```
$ {{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:30}}
...
```
{{#include ../../../zarathustra_cli/examples/book/mpc_tutorial/test.sh:32:38}}
```
